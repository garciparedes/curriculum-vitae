...
%-------------------------------------------------------------------------------
  ...
  \section{summary}
    ...
    In the writting area, I've started to use \texttt{\LaTeX} as a way to submit class assigments in a cleaner way, but it has become in one of my passions. Right now is the primary method I used to comunicate important things, but not the only one. Another of my favorite ways (especially when code is involved) is \texttt{Jupyter Notebook}, like I will explain bellow.
...
%-------------------------------------------------------------------------------
  ...
  \section{education}
    ...
    \begin{entrylist}
      ...
      \entry
      {2017--present}
      {\myhref{http://www.eio.uva.es/}{Bachelor's Degree {\normalfont of Statistics}}}
      {\UVa}
      {}
      ...
      \entry
      {2013--2017}
      {\myhref{https://www.inf.uva.es/}{Bachelor's Degree {\normalfont of Computer Engineering}}}
      {\UVa}
