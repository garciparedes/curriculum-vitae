...
%-------------------------------------------------------------------------------
  ...
  \section{work}
    ...
    \begin{entrylist}
      ...
      {
        \begin{itemize}
          \item Be the core engineer of an Autonomous and Unsupervised Testing System, based on scraping, being able to detect almost all interface changes and schedule navigation paths towards more susceptible bug areas.
