...
\newcommand{\Amazon}{\myhref{https://amazon.com/}{\textbf{Amazon}}}
...
%-------------------------------------------------------------------------------
  ...
  \section{skills}
      ...
      \begin{itemize}
        \item \textbf{Languages:} Kotlin, Python, TypeScript, Java.
        \item \textbf{Cloud:} AWS (CloudFormation, CDK, DynamoDB, EC2, ECS, Lambda, S3, SNS, SQS, Step Functions).
        \item \textbf{Math \& Data:} Combinatorial Optimization, VRP, Algorithms, Statistics.
      \end{itemize}
...
%-------------------------------------------------------------------------------
  ...
  \section{work}
    ...
    \begin{entrylist}
      ...
      {
        \begin{itemize}
          \item \textbf{Team:} Amazon - EU InTech - Consumer Selection Discovery
        \end{itemize}
      }
      ...
      {\AWS}
      {
        \begin{itemize}
          ...
          \item \textbf{Built} a Region Build Automation (RBA) framework with AWS CDK on top of Amazon internal tooling. \textbf{Drastically reduced} the effort to expand AWS Services to new regions from weeks to days by \textbf{leveraging cross-account resource referencing}.
        \end{itemize}
      }
